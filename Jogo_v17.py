...
def main():
    ...
    while teste:
        ...
        if current_time - last_spawn_time > spawn_delay:
            if cronometro <= 20000:
                criar_fantasma1()
            elif cronometro > 20000 and cronometro<= 40000:
                criar_fantasma2()
            elif cronometro > 4000 and cronometro <= 60000:
                criar_fantasma3()
            elif cronometro> 60000 and cronometro <= 80000:
                criar_fantasma4()
            elif cronometro > 80000 and cronometro <= 120000:
                criar_fantasma5()
            elif cronometro > 120000 and cronometro <= 150000:
                criar_fantasma6()
            elif cronometro > 150000 and cronometro <= 200000:
                criar_fantasma7()
            elif cronometro > 200000 and cronometro <= 250000:
                criar_fantasma8()
                spawn_delay = 500 # Pros fantasmas spawnarem mais depressa 
            elif cronometro > 250000 and cronometro <= 300000:
                criar_fantasma9()
            elif cronometro > 300000 and cronometro <= 400000:
                criar_fantasma10()
